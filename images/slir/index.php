...
$ROOT = substr($url, 0, strpos($url, "Athletics/Mens_Ultimate")); //This is a hack to find the root directory on the filesystem so we can point to stuff correctly.
